...
joystick_position_t joystick_get_pos(void)
{
    ...
    if (x_dir < JOYSTICK_THRESH_X_RIGHT_0P825V) {
        if (y_dir < JOYSTICK_THRESH_Y_DOWN_0P825V){
    ...
    } else if ((y_dir < JOYSTICK_THRESH_Y_DOWN_0P825V) && (x_dir > JOYSTICK_THRESH_X_RIGHT_0P825V) && (x_dir < JOYSTICK_THRESH_X_LEFT_2P475V)) {
        position = JOYSTICK_POS_DOWN;
    } else if ((y_dir > JOYSTICK_THRESH_Y_UP_2P475V) && (x_dir > JOYSTICK_THRESH_X_RIGHT_0P825V) && (x_dir < JOYSTICK_THRESH_X_LEFT_2P475V)) {
